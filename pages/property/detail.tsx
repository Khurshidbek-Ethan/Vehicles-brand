...
import DisCard from '../../libs/components/common/PropertyBigCard';
						...
						<Stack className={'property-info-config'}>
							<Stack className={'info'}>
								<Stack className={'left-box'}>
									<Typography className={'title-main'}>{property?.propertyBrand}</Typography>
								</Stack>
						...
						<Stack className={'property-desc-config'}>
							<Stack className={'left-config'}>
								<Stack className={'options-config'}>
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
											<svg
												...
												width="580.000000pt"
												height="387.000000pt"
												viewBox="0 0 580.000000 387.000000"
											...
											>
												...
												>
													<path
														d="M2360 2744 c-280 -36 -575 -159 -795 -334 -52 -41 -71 -50 -145 -65
													...
													/>
													<path
														d="M3200 2364 c-25 -2 -103 -9 -175 -15 -154 -12 -428 -46 -765 -95
													...
													/>
													<path
														d="M2894 1963 c-28 -3 -49 -12 -64 -28 -13 -14 -22 -26 -19 -28 2 -2 50
									...
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
											<img src="/img/icons/collo.png" alt="" />
										</Stack>
										<Stack className={'option-includes'}>
											<Typography className={'title'}></Typography>
									...
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
											<img src="/img/icons/date.png" alt="" />
										</Stack>
										<Stack className={'option-includes'}>
									...
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
											<img src="/img/icons/car1.png" alt="" />
										</Stack>
										<Stack className={'option-includes'}>
							...
							<Stack className={'right-config'}>
								...
								<Stack className={'info-box'}>
									...
									<textarea placeholder={'Hello, You can write here  \n'}></textarea>
								</Stack>
								<Stack className={'info-box'}>
